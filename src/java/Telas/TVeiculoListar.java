...
@WebServlet(name = "TVeiculoListar", urlPatterns = {"/TVeiculoListar"})
public class TVeiculoListar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("           <form action='TVeiculoListar' method='Post'>");
            out.println("           <table class='Pesquisa' border=0 width=100%>");
            out.println("               <tr><th colspan=20 class='Titulo'>Módulo de Veículos</th></tr>");
            out.println("               <tr>");
            ...
            out.println("                   <td><input type='text' name='aquisicao' value='' size=10></td>");
    ...
    public void Listar(HttpServletResponse response, String opcao) throws IOException, SQLException{
        ...
        for (int x=0; x < vFrVeiculos.size(); x++){
            ...
            out.println("<tr>");
            out.println("   <td><input type='image' name='Alterar' value='"+ vFrVeiculos.get(x).getId() +"' src='imagens/alterar.jpg' width=15px height=15px></td>");
            ...
            if (vFrVeiculos.get(x).getAquisicao() == null)
            ...
            out.println("   <td "+ grade +">"+ iMenu.CategoriaVeiculoDescricao(vFrVeiculos.get(x).getCategoria()) +"</td>");
            out.println("   <td><input type='image' name='Excluir' value='"+ vFrVeiculos.get(x).getId() +"' src='imagens/excluir.png' width=15px height=15px></td>");
            out.println("</tr>");
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(TVeiculoListar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
